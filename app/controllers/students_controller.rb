class StudentsController < ApplicationController
  ...
  def create
    ...
    if @student.save
      redirect_to @student, notice: "#{@student.student_name} was added to the system."
    else
      render action: 'new'
    end
  end
  ...
  def update
    if @student.update(student_params)
      redirect_to @student, notice: "#{@student.student_name} was revised in the system."
    else
      render action: 'edit'
    end
  end
  ...
  def destroy
    @student.destroy
    redirect_to students_url, notice: "#{@student.student_name} was removed from the system."
  end
